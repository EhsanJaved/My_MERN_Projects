      ...
      {prod.map(idx => (
        <Col>
          <Card className='btn-outline-success mx-1 '>
            ...
            <Card.Body>
              <Card.Title><b>Name: </b>{idx.prductname}</Card.Title>
              <Card.Text>
              <i className='fw-bold fst-normal'key={idx._id}>ID: </i> {idx._id}
             <br />
             <i className='fw-bold fst-normal'> Cost Price: </i> Rs.{idx.costprice}
             <br />
             <i className='fw-bold fst-normal'>Sell Price: </i> Rs.{idx.sellprice}
             <br />
             <i className='fw-bold fst-normal'>In stock:</i>  {idx.instock} pices
             <br />
             <i className='fw-bold fst-normal'>sold:</i> {idx.sold} pices
             <br />
             <i className='fw-bold fst-normal'>Last Updated:</i> {idx.updatedAt}
             <br />
             <button className='btn btn-outline-primary my-2 mx-4 ms-5'><i className='mx-3'>Edit</i></button>
             <button className='btn btn-outline-primary my-2 mx-1'><i className='mx-3'>Delete</i></button>
              </Card.Text>
            </Card.Body>
          </Card>
        ...
        <Modal.Body>
          <Form onSubmit={event => handleSubmit(event)}>
            <Form.Group   className="mb-3" controlId='exampleForm.ControlInput1'>
              ...
              <Form.Control type="name" placeholder="Name" autoFocus controlId='exampleForm.ControlInput1' />
            </Form.Group>
